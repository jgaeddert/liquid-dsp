...
function(liquid_print_config_summary)
    ...
    liquid_status("  SSE               : " SSE THEN "Yes" ELSE "No") # USE_SSE AND COMPILER_HAS_SSE_FLAG THEN "Yes" ELSE "No")
    liquid_status("  AVX               : " AVX THEN "Yes" ELSE "No") # USE_AVX AND COMPILER_HAS_AVX_FLAG THEN "Yes" ELSE "No")
    liquid_status("  AVX2              : " AVX2 THEN "Yes" ELSE "No") # USE_AVX2 AND COMPILER_HAS_AVX2_FLAG THEN "Yes" ELSE "No")
