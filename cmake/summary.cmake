...
function(liquid_print_config_summary)
    ...
    liquid_status("  SSE4              : " C_SSE4_FOUND THEN    "Yes, flags='${C_SSE4_FLAGS}'"    ELSE "No")
    ...
    liquid_status("  AVX512            : " C_AVX512_FOUND THEN  "Yes, flags='${C_AVX2_FLAGS}'"    ELSE "No")
    ...
    # libfec
    if (fec_FOUND)
    liquid_status("  FEC               : " "include path='${fec_INCLUDE_DIR}'")
    liquid_status("                    : " "library path='${fec_LIBRARY}'")
    else()
    liquid_status("  FEC               : " "No")
    endif()
    liquid_status("")
