...
void modem_demodulate_soft_bpsk(modem _demod, float complex _x, unsigned char * _bits_out);
void modem_demodulate_soft_qpsk(modem _demod, float complex _x, unsigned char * _bits_out);
