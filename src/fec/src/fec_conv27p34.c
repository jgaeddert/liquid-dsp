...
#define FEC_CONV(name)      LIQUID_CONCAT(fec_conv27p34,name)
...
#define fec_conv27p34_R     (2)
#define fec_conv27p34_K     (7)
#define fec_conv27p34_mode  FEC_CONV_V27P34
#define fec_conv27p34_P     (3)
