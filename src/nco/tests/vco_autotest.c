...
#ifndef __LIQUID_AUTOTEST_VCO__
#define __LIQUID_AUTOTEST_VCO__
...
//
// test floating point precision vco
//
void autotest_vco_basic() {
...
// test vco mixing
//
void autotest_vco_mixing() {
    // frequency, phase
    float f = 0.1f;
    float phi = M_PI;

    // error tolerance (high for VCO)
    float tol = 0.05f;
