...
#define LIQUIDFPM_AUTOTEST_EXP2_SHIFTADD_API(Q)                     \
...
// define autotest API
LIQUIDFPM_AUTOTEST_EXP2_SHIFTADD_API(LIQUIDFPM_MANGLE_Q16)
LIQUIDFPM_AUTOTEST_EXP2_SHIFTADD_API(LIQUIDFPM_MANGLE_Q32)
