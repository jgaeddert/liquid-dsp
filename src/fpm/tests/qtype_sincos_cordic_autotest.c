...
#define LIQUIDFPM_AUTOTEST_SINCOS_CORDIC_API(Q)                     \
...
// define autotest API
LIQUIDFPM_AUTOTEST_SINCOS_CORDIC_API(LIQUIDFPM_MANGLE_Q32)
LIQUIDFPM_AUTOTEST_SINCOS_CORDIC_API(LIQUIDFPM_MANGLE_Q16)
