...
\input{sections/tutorial_pll}
%\input{sections/tutorial_modem}
\input{sections/tutorial_fec}
\input{sections/tutorial_framing}
\input{sections/tutorial_ofdmflexframe}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\part{Fixed-point Math}
\label{part:fpm}

\bigskip
\noindent
New to an un-annouced version of \liquid\ is the integration of a fully
functional fixed-point math library.
The {\tt fpm} module in \liquid\ implements the standard math library
for fixed-point precision and
is intended to target embedded devices without a floating-point
co-processor.
