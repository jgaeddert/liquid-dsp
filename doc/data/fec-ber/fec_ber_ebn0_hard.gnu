...
plot \
    ...
    'data/fec-ber/hard/ber_bpsk.dat'     using 2:3 with linespoints linewidth 2.0 pointtype 6 linecolor rgb '#000000' title 'Uncoded',\
    ...
    'data/fec-ber/hard/ber_h128.dat'     using 2:3 with linespoints linewidth 1.2 pointtype 6 linecolor rgb '#004080' title 'Hamming(12,8)',\
    ...
    'data/fec-ber/hard/ber_h84.dat'      using 2:3 with linespoints linewidth 1.2 pointtype 6 linecolor rgb '#008010' title 'Hamming(8,4)',\
