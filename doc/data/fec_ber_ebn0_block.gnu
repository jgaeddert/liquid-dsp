...
plot \
    ...
    'data/ber-fec-hard/ber_secded2216.dat'  using 2:3 with linespoints linewidth 1.2 pointtype 6 linecolor rgb '#e040c0' title 'SEC-DED(22,16)',\
    ...
    'data/ber-fec-hard/ber_secded7264.dat'  using 2:3 with linespoints linewidth 1.2 pointtype 6 linecolor rgb '#8040c0' title 'SEC-DED(72,64)',\
