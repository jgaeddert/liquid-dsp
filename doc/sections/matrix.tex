...
\subsubsection{{\tt matrix\_trans}, {\tt matrix\_hermitian()} (transpose matrix)}
\label{module:matrix:trans}
The {\tt matrix\_trans(X,m,n,XT)} method
...
\]
%
Similarly, the {\tt matrix\_hermitian(X,m,n,XH)} computes the Hermitian
