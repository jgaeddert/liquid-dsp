...
using Doolittle's method (see {\tt matrix\_ludecom\_doolittle}) and then
...
\]
This is equivalent to performing L/U decomposition using Crot's method and
then computing the product of the diagonal elements of $\vec{L}$.
\begin{verbatim}
fmatrix_det(X,4,4) = 585.40289307
\end{verbatim}
