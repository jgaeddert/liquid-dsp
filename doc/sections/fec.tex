...
Table~\ref{tab:fec:codecs} lists the available codecs...

\subsubsection{basic codecs}
\label{module:fec:codecs:basic}

\subsubsection{convolutional codecs}
\label{module:fec:codecs:conv}

\subsubsection{punctured codes}
\label{module:fec:codecs:punctured}

\subsubsection{Reed-Solomon codecs}
\label{module:fec:codecs:rs}
...
{\tt FEC\_CONV\_V29P78}         & 7/8       & $K=9$, $d_{free}=4$\\\bottomrule
