...
... xxx
%Our program will hardly be longer than...
...
% tasks:
%   * modify the framesync64_create() to include frame counter
%   * update callback function to print more info
%   * run framesyng64_execute() one sample at a time
