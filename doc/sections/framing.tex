...
\label{eqn:ofdmframegen:window}
    %w_n = \sin^2\Bigl( \pi(n + 1/2)/N_t \Bigr)
    w_n = \sin^2\Bigl( \pi\frac{n + 1/2}{N_t} \Bigr)
\end{equation}
%
\begin{figure}
\centering
  \includegraphics[trim = 0mm 0mm 0mm 0mm, clip, width=14cm]{figures.pgf/ofdm_window_tapering_diagram}
...
\begin{figure}
\centering
  \includegraphics[trim = 0mm 6mm 0mm 8mm, clip, width=13cm]{figures.gen/ofdmflexframe_performance}
