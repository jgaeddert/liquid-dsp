...
The {\tt interleaver} object operates like most objects in \liquid; ...
...
\item[{\tt interleaver\_encode()}]
    runs the forward interleaver
\item[{\tt interleaver\_decode()}]
    runs the reverse interleaver
\end{description}
...
This listing demonstrates the interface to the {\tt interleaver} object.
