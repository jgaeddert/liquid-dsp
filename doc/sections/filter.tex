...
{\tt msresamp} is a multi-stage arbitrary resampler use for efficient
interpolation and decimation.
The {\tt msresamp} object uses a combination of half-band
interpolators/decimators (Section~\ref{module:filter:resamp2})
and an arbitrary resampler (Section~\ref{module:filter:resamp})
to efficiently realize any arbitrary resampling rate desired.
...
\item[{\tt msresamp\_crcf\_create(r,As)}]
    ...
    and a stop-band suppression of $A_s$~dB.
...
\caption{{\tt msresamp\_crcf} (multi-stage resampler) interpolator demonstration}
