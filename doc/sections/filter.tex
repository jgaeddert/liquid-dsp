...
\subsubsection{iirdes filter types}
...
\item[{\tt LIQUID\_IIRDES\_BUTTER}]
    ...
    This is an all-pole design that has a maximally flat magnitude response in
    the pass-band.
...
\item[{\tt LIQUID\_IIRDES\_CHEBY2}]
    ...
    polynomial in the denominator has been inverted.
    As a result, it exhibits an equiripple behavior in the stop-band, rather
    than the pass-band.
