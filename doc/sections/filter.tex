...
is the ... (see \S\ref{module:math:transcendentals:Q}).
%
Receive filter: ...
%
\begin{figure}
...
\centering
\subfigure[spectrum] {
  \includegraphics[trim = 0mm 5mm 0mm 5mm, clip, width=0.55\textwidth]{figures.gen/filter_butter_psd}
}
...
\centering
\subfigure[spectrum] {
  \includegraphics[trim = 0mm 5mm 0mm 5mm, clip, width=0.55\textwidth]{figures.gen/filter_cheby1_psd}
}
\subfigure[zeros, poles] {
...
\centering
\subfigure[spectrum] {
  \includegraphics[trim = 0mm 5mm 0mm 5mm, clip, width=0.55\textwidth]{figures.gen/filter_cheby2_psd}
}
\subfigure[zeros, poles] {
...
\centering
\subfigure[spectrum] {
  \includegraphics[trim = 0mm 5mm 0mm 5mm, clip, width=0.55\textwidth]{figures.gen/filter_ellip_psd}
}
\subfigure[zeros, poles] {
...
\centering
\subfigure[spectrum] {
  \includegraphics[trim = 0mm 5mm 0mm 5mm, clip, width=0.55\textwidth]{figures.gen/filter_bessel_psd}
}
\subfigure[zeros, poles] {
...
\subfigure[decimation] {
  \includegraphics[trim = 0mm 0mm 0mm 0mm, clip, width=13cm]{figures.pgf/msresamp_decim_diagram}
}
\subfigure[interpolation] {
  \includegraphics[trim = 0mm 0mm 0mm 0mm, clip, width=13cm]{figures.pgf/msresamp_interp_diagram}
}
\caption{Multi-stage resampler}
...
\subsection{{\tt resamp2} (halfband filter/resampler)}
