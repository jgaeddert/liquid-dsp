...
{\small
    ...
    ${n \choose k}$         & {\tt liquid\_nchoosek(n,k)} \\
    $\vec{X}^H\vec{X}  $  & {\tt matrixcf\_transpose\_mul(x,m,n,xHx)} \\\bottomrule
    \end{tabular*}
}
\end{table*}%
% ------------------------
...
$I_\nu(z)$ is the modified Bessel function of the first kind and are
