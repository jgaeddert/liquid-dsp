...
\caption{Scenario 1: 10-tap equalizer for a 6-tap channel with 40~dB SNR}
...
% trim = left bottom right top
\caption{Scenario 2: 18-tap equalizer for a 8-tap channel with 14~dB SNR}
...
\subfigure[Power Spectral Density] {
    \includegraphics[trim = 2mm 6mm 0mm 6mm, clip, width=15cm]{figures.gen/eqlms_cccf_blind_freq}
    \label{fig:module:equalization:eqlms_blind:psd}
}
%\subfigure[constellation] {
