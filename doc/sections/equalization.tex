...
\mbox{
  \subfigure[PSD] {
      \includegraphics[trim = 16mm 0mm 20mm 0mm, clip, width=6cm]{figures.gen/equalizer_example2_psd}
      \label{fig:module:equalization:example2:psd}
    } \quad
  \subfigure[constellation] {
      \includegraphics[trim = 16mm 0mm 20mm 0mm, clip, width=6cm]{figures.gen/equalizer_example2_const}
...
\mbox{
  ...
  \subfigure[mean-squared error] {
      \includegraphics[trim = 16mm 0mm 18mm 0mm, clip, width=6cm]{figures.gen/equalizer_example2_mse}
