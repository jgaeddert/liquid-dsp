...
\mbox{
  \subfigure[PSD] {
      \includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures.gen/eqlms_cccf_psd}
      \label{fig:equalizer_example1:psd}
    } \quad
  \subfigure[constellation] {
      \includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures.gen/eqlms_cccf_const}
      \label{fig:equalizer_example1:constellation}
    } \quad
}
\mbox{
  \subfigure[taps] {
      \includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures.gen/eqlms_cccf_taps}
      \label{fig:equalizer_example1:taps}
    } \quad
  \subfigure[mean-squared error] {
      \includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures.gen/eqlms_cccf_mse}
      \label{fig:equalizer_example1:mse}
    } \quad
}
...
\mbox{
  \subfigure[PSD] {
      %\includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures/equalizer_example2_psd}
      \label{fig:equalizer_example2:psd}
    } \quad
  \subfigure[constellation] {
      %\includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures/equalizer_example2_constellation}
      \label{fig:equalizer_example2:constellation}
    } \quad
}
\mbox{
  \subfigure[taps] {
      %\includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures/equalizer_example2_taps}
      \label{fig:equalizer_example2:taps}
    } \quad
  \subfigure[mean-squared error] {
      %\includegraphics[trim = 5mm 0mm 5mm 0mm, clip, width=7.5cm]{figures/equalizer_example2_error}
      \label{fig:equalizer_example2:mse}
    } \quad
}
% trim = left bottom right top
