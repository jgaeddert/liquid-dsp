...
\tikzstyle{block}=[
    ...
    very thick,
    minimum size=20mm,
    fill=liquid-color-mutedgreen!20]
...
\begin{tikzpicture}[
    ...
    % draw major blocks
    \node[textbox]          (input)                                        {$x$};
    \node[block,fill=white] (arbitrary-resamp) [right=of input]            {$1 \leq r \leq 2$};
    \node[block]            (halfband-a)       [right=of arbitrary-resamp] {$\uparrow 2$};
    \node[block]            (halfband-b)       [right=of halfband-a]       {$\uparrow 2$};
    \node[textbox]          (dotdotdot)        [right=of halfband-b]       {...};
    \node[block]            (halfband-n)       [right=of dotdotdot]        {$\uparrow 2$};
