...
For platforms where floating-point precision is a bridge too far,
liquid-dsp includes methods for creating objects to work with fixed-point
precision.

.. code-block:: c

    // get in, process data, get out
    #include <liquid/liquid-fpm.h>
    int main() {
        // ...
    }
...
* **fft**: fast Fourier transforms (arbitrary length), discrete sin/cos
  transforms
* **fpm**: fixed-point math: basic arithmetic, trigonometric,
