// file: eqlms_rrrf_example.c
//
// Tests least mean-squares equalizer
//
// Complile and run:
//   $ gcc eqlms_rrrf_example.c -lliquid -o eqlms_rrrf_example
//   $ ./eqlms_rrrf_example
...
#define DEBUG_FILENAME "eqlms_rrrf_example.m"
...
int main() {
    ...
    // create equalizer
    eqlms_rrrf eq = eqlms_rrrf_create(p);
    ...
    for (i=0; i<p; i++)
        w[i] = 0;
    eqlms_rrrf_train(eq, w, y, d, ntrain);
